            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <?php 
                                $query = "SELECT image FROM books WHERE bookid=1";
                                ...
                                echo "<a href='readbook.php?bookid=1&user=$uname'>Read More...</a>";
                            ?>
                ...
                <div class="swiper-slide">
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                $query = "SELECT image FROM books WHERE bookid=2";
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='readbook.php?bookid=2&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                $query = "SELECT image FROM books WHERE bookid=3";
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='readbook.php?bookid=3&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='readbook.php?bookid=4&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                $query = "SELECT image FROM books WHERE bookid=6";
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='readbook.php?bookid=6&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                $query = "SELECT image FROM books WHERE bookid=7";
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='readbook.php?bookid=7&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                $query = "SELECT image FROM books WHERE bookid=8";
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='readbook.php?bookid=8&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                $query = "SELECT image FROM books WHERE bookid=9";
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='readbook.php?bookid=9&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
