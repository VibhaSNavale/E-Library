                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <?php 
                                ...
                                echo "<a href='AAreadbook.php?bookid=1&user=$uname'>Read More...</a>";
                            ?>
                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='AAreadbook.php?bookid=2&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            <?php 
                                ...
                                echo "<img style='width:180px; height:225px;' src='imgs/$image'/>";
                                echo "<a href='AAreadbook.php?bookid=3&user=$uname'>Read More...</a>";
                            ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section links">
                    ...
                    <ul>
                        ...
                        <a href="about.php?user=<?php echo htmlspecialchars($uname, ENT_QUOTES);  ?>"><li>About</li></a>
